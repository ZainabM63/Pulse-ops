...
// Fix: Reset SCRIPT_NAME so Symfony/Laravel preserve the full REQUEST_URI path.
// vercel-php sets SCRIPT_NAME to /api/index.php which causes Symfony to strip
// the /api/ prefix, breaking Laravel route matching.
